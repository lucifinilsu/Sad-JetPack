        ...
        for (Method method:methods
            ...
            if (chat!=null){
                ...
                for (String url:urls
                    ...
                    String dynamicExposedServiceClsName= NameUtils.getDynamicComponentClassSimpleName(hostClsName,proxyUrlEncrypt,"$$");
                    //生成实例对象
                    try{
                        ...
                        //存入集合
                        ExposedServiceInstanceStorageManager.registerExposedServiceInstance(proxyUrlEncrypt+ ExposedServiceInstanceStorageManager.PATH_KEY_SEPARATOR+host.hashCode(),dynamicComponent);
                    }catch (Exception e){
                        e.printStackTrace();
                    }
                }
            ...
            if (chat!=null){
                ...
                for (String url:urls){
                    ...
                    try{
                        ...
                        ExposedServiceInstanceStorageManager.unregisterExposedServiceInstance(proxyUrlMD5+ ExposedServiceInstanceStorageManager.PATH_KEY_SEPARATOR+host.hashCode());
